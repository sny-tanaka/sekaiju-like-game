...
| ボス | 旧HP | 確定HP（§17 忠実シミュ収束） | ターン数 |
| --- | --- | --- | --- |
| 門番のゴーレム(F10) | 220 | **9000** | 21t |
| 山嶺の大猿王(F20) | 620 | **7000** | 18t |
| 氷晶の女王(F30) | 1300 | **18000** | 20t |
| 雷霆の覇王(F40) | 2500 | **13000** | 21t |
| 瘴気を統べる腐王(F50) | 4200 | **13500** | 21t |

> 確定値は §17 の**忠実シミュ（実 `resolveTurn` 駆動・スキルは実エンジン同様 Lv1 威力）**で 18〜22ターン・必勝・最低パーティHP率≤15% に収束させたもの。F30 が突出して高いのは、氷晶の女王の VIT が低く（被軽減が小さい＝パーティの与ダメが通りやすい）20ターン保たせるのに多くの HP を要するため（HP の大小ではなくターン数で難度が揃っている）。F60+ は `enemyScale` が HP もパーティ火力も伸ばすので相対関係は保たれる。
