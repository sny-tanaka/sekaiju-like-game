...
import { mockSubClass, mockWithParty } from '@/__stories__/mockSaves';
...
/** キャラ詳細（副業「薬師」設定済み） */
export const WithSubClass: Story = {
  decorators: [withGameContext(mockSubClass, { name: 'guildChar', id: firstMemberId })],
};
