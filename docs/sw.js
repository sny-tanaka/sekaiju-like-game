if (!self.define) {
  ...
  self.define = (e, a) => {
    ...
    let i = {};
    const u = (s) => r(s, l),
      _ = { module: { uri: l }, exports: i, require: u };
    n[l] = Promise.all(e.map((s) => _[s] || u(s))).then((s) => (a(...s), i));
  };
}
define(['./workbox-1ef09536'], function (s) {
  ...
  (self.addEventListener('message', (s) => {
    ...
    s.precacheAndRoute(
      [
        { url: 'index.html', revision: '12195303086a78b9f88248b21594dbd4' },
        ...
        { url: 'assets/index-B9gc5wrr.css', revision: null },
        { url: 'assets/index-B2L6qLrG.js', revision: null },
        { url: 'favicon.ico', revision: 'bf53cfc1c1a7432fa532b35b76682d50' },
        { url: 'icon-192.png', revision: '2abc40b6b11f19c114b43abb7733a687' },
        { url: 'icon-512.png', revision: 'aea6735f0e3902695c58dbca460dc603' },
