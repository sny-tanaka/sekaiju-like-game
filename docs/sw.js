if (!self.define) {
  ...
  self.define = (s, r) => {
    ...
    i[o] = Promise.all(s.map((e) => l[e] || t(e))).then((e) => (r(...e), c));
  };
}
define(['./workbox-1ef09536'], function (e) {
  ...
  (self.addEventListener('message', (e) => {
    ...
    e.precacheAndRoute(
      [
        { url: 'index.html', revision: '53294889772d5e3d2ab8c11bbcf80bdf' },
        ...
        { url: 'assets/index-pDozZF2x.js', revision: null },
        { url: 'assets/index-CYZmwAFV.css', revision: null },
        { url: 'favicon.ico', revision: 'bf53cfc1c1a7432fa532b35b76682d50' },
        { url: 'icon-192.png', revision: '2abc40b6b11f19c114b43abb7733a687' },
        { url: 'icon-512.png', revision: 'aea6735f0e3902695c58dbca460dc603' },
